...
sap.ui.define([
  ...
  return Control.extend('sap.ui.demo.walkthrough.control.ProductRating', {
    metadata: {
      properties: {
        // hold the value of the selected rating
        // Getter and setter function for this property will automatically be created
        value: { type: 'float', defaultValue: 0 }
      },
      aggregations: {
        // Packing the Controls into Aggregations in order to leaverage the automatic lifecycle management
    ...
    // init is called everytime a new instance of the control is created
    init: function () {
